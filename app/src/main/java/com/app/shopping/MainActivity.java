...
//    {
//        User user = new User("",phone,password,2,"");
//        ApiService.apiService.isUserOrAdmin(user).enqueue(new Callback<User>() {
//            @Override
...
//                    Intent intent = new Intent(MainActivity.this, com.app.shopping.AdminCategoryActivity.class);
//                    startActivity(intent);
//                }
//
//            }
